 ...
 * 
 * Usage:
 *   php cp.php create <username> <password> [email]
 *   php cp.php pass <username> <new-password>
 *   php cp.php list
 */
...
switch ($cmd) {
    case 'create':
        ...
        if (!$username || !$password) {
            die("Usage: php cp.php create <username> <password> [email]" . PHP_EOL);
        }
    ...
    case 'pass':
        ...
        if (!$username || !$newpass) {
            die("Usage: php cp.php pass <username> <new-password>" . PHP_EOL);
        }
    ...
    default:
        ...
        echo "  php cp.php create <user> <pass> [email]   ساخت ادمین جدید" . PHP_EOL;
        echo "  php cp.php pass  <user> <new-pass>        تغییر رمز ادمین" . PHP_EOL;
        echo "  php cp.php list                           لیست کاربران" . PHP_EOL;
        echo PHP_EOL;
        break;
}
