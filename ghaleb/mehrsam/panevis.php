<!-- پاصفحه -->
<footer style="background:#1a1a1a; color:#ccc; margin-top:0;">
        ...
        <div style="display:grid; grid-template-columns:2fr 1fr 1fr; gap:40px;">
            ...
            <div>
                ...
                <div style="display:flex; gap:10px;">
                    <a href="#" style="width:36px;height:36px;background:#333;border-radius:8px;display:flex;align-items:center;justify-content:center;color:#fff;transition:all 0.3s;" onmouseover="this.style.background='var(--rang-asli)'" onmouseout="this.style.background='#333'">
            ...
            <div>
                ...
                <ul style="display:flex; flex-direction:column; gap:10px;">
                    ...
                    <li>
                        <a href="<?= BASE_URL . $lnk[0] ?>" style="color:#bbb; font-size:14px; display:flex; align-items:center; gap:6px; transition:color 0.3s;" onmouseover="this.style.color='var(--rang-asli)'" onmouseout="this.style.color='#bbb'">
                            <i class="fa-solid fa-chevron-left" style="font-size:10px; color:var(--rang-asli);"></i>
                            <?= $lnk[1] ?>
                        </a>
                    </li>
                    <?php endforeach; ?>
